    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        >
          <AnimatePresence mode="wait">
            {dayData.narrative.slice(0, narrativeIndex + 1).map((text, i) => (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: i === narrativeIndex ? 0 : 0 }}
              >
                {text}
              </motion.p>
            ))}
          ...
          {/* Alex's message */}
          {allNarrativeShown && dayData.alexMessage && (
            <motion.div
            ...
            >
              <div className="bg-chat-bubble px-4 py-2.5 rounded-2xl rounded-bl-sm max-w-[80%]">
                <p className="text-xs text-muted-foreground mb-1 font-mono">Alex</p>
          ...
          >
            {!chosen ? (
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <div className="px-4 py-3 bg-chat-self rounded-2xl rounded-br-sm">
                  <p className="text-sm">
